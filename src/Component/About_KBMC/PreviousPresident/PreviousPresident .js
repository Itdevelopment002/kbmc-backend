...
const PreviousPresidents = () => {
    ...
    const confirmDelete = () => {
        setPresidents(presidents.filter((president) => president.id !== selectedPresidentId));
    ...
    const handleEditSubmit = (e) => {
        ...
        const updatedPresidents = presidents.map((president) =>
            president.id === selectedPresidentId ? editData : president
        );
                                    ...
                                    <div className="row mb-3">
                                        ...
                                        <div className="col-sm-8 col-9 text-end m-b-20">
                                            <a
                                                ...
                                                className="btn btn-primary btn-rounded float-right "style={{ borderRadius: '100px' }}
                                            >
                                            ...
                                            <tbody>
                                                {presidents.map((president, index) => (
                                                    <tr key={president.id}>
                                                        ...
                                                        <td>{president.startDate}</td>
                                                        <td>{president.endDate}</td>
                                                        <td>
                                                            <img
